...
**xenomoon** Claude Code plugin the framework loads into every game session.
...
- `plugin/` — the **xenomoon** Claude Code plugin: the framework's agents, skills, tools, hooks
  ...
  once (`.claude-plugin/marketplace.json`). Capabilities namespace as `xenomoon:<name>`.
