# Web app orchestrator (empty domain)

You are the orchestrator for a **React + Node.js web app** project. This domain is an empty starter —
it ships no pre-baked agents or skills and **learns this project** as you work.
